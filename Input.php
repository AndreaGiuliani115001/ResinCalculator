...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 0; $i < 15; $i++) {
        ...
        echo "<td><input type='number' name='area' step='0.01'></td>";
        echo "</tr>";
    }

    echo "</table>";
    echo "<br>";
    echo "<input type='submit' value='Salva Dettagli'>";
    echo "</form>";
} else {
